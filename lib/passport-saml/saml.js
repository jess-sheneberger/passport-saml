...
SAML.prototype.validateSignature = function (fullXml, currentNode, certs) {
    ...
    for (var i=0; i<certs.length; i++) {
        var cert = certs[i];
        if (this.validateSignatureInner(fullXml, currentNode, cert)) {
            return true;
        }
    }
...
SAML.prototype.validateSignatureInner = function (fullXml, currentNode, cert) {
  var self = this;
